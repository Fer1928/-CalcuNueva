...
public class Calculadora extends JFrame {
	 ...
	 * correspondiente
	 */
	public static double sin(double sen){
            return 0;
        ...
        public static double tan(double tan){
            return 0;
	...
	private void calcularResultado() {
		if (operacion.equals("+")) {
			...
			resultado *= new Double(pantalla.getText());
                     ...
                     double seno = Math.sin(new Double(pantalla.getText()) );
                     resultado = seno; 
                }else if  (operacion.equals("cos")){
                    double cose = Math.cos(new Double(pantalla.getText())); 
                    resultado = cose;
                }else if  (operacion.equals("tan")){
                    double tang = Math.tan(new Double(pantalla.getText()));
                    resultado = tang;
                }else if  (operacion.equals("e")){
                    double exp = Math.exp(new Double(pantalla.getText()));
                    resultado = exp;
                 }else if  (operacion.equals("log")){
                    double loga = Math.log(new Double(pantalla.getText()));
                    resultado = loga;
